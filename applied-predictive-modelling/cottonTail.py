...
def findCorrelation(corr, cutoff=0.9, exact=None):
    ...
    def _findCorrelation_exact(corr, avg, cutoff):
        ...
        # avg: muuttujien korrelaatioiden keskiarvot sisältävä LISTA
        # em. lista suuruusjärjestyksessä: avg.sort_values(ascending=False).index
        # 
        # tuplen avulla lajittelee alkuperäisen korrelaatiomatriisin rivit ja sarakkeet
